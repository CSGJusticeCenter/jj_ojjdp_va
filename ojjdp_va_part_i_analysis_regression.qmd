...
pred_prob_dispo_csu <- predictions(va_dispo_model, variables = c("csu")) 
...
pred_prob_dispo_dai <- predictions(va_dispo_model, variables = c("dai_clean")) 
...
pred_prob_dispo_status_by_csu <- predictions(va_dispo_model, variables = c("dai_clean","csu")) %>%
  filter(dai_clean%in%c("Status Offense"))
